google.maps.__gjsload__('common', function(_) {
    ...
    iga = function(a) {
        ...
        a.setAttribute("aria-roledescription", "harita")
    };
    _.Rl = function(a) {
    ...
    _.dr = function(a) {
        ...
        var b = _.Oe("CloseButtonView", "element", function() {
            return _.Me(_.Fe(HTMLButtonElement, "HTMLButtonElement"))(a.element) || _.br(a.label || "Kapat")
        });
    ...
    jia = function() {
        ...
        _.zg && (_.kb(_.zg, function(b) {
                ...
                if (b.type) b.disabled = !0, b.placeholder = "Hata! Bir sorun olu\u015ftu.", b.className += " gm-err-autocomplete", b.style.backgroundImage = "url('" + c + "')";
                else {
                    b.innerText = "";
                    var d = _.Ze("div");
                    ...
                    b.appendChild(c);
                    c.innerText = "Hata! Bir sorun olu\u015ftu.";
                    c = _.Ze("div");
                    c.className = "gm-err-message";
                    b.appendChild(c);
                    c.innerText = "Bu sayfa Google Haritalar'\u0131 d\u00fczg\u00fcn \u015fekilde y\u00fckleyemedi. Teknik ayr\u0131nt\u0131lar i\u00e7in JavaScript konsoluna bak\u0131n."
                }
            }),
    ...
    _.xia = function(a) {
        ...
        "" === e || void 0 == e ? (Zs || (e = {}, Zs = (e.atomic = !1, e.autocomplete = "none", e.dropeffect = "none", e.haspopup = !1, e.live = "off", e.multiline = !1, e.multiselectable = !1, e.orientation = "vertical", e.readonly = !1, e.relevant = "additions text", e.required = !1, e.sort = "none", e.busy = !1, e.disabled = !1, e.hidden = !1, e.invalid = "false", e)),
            e = Zs, "label" in e ? d.setAttribute("aria-label", e.label) : d.removeAttribute("aria-label")) : d.setAttribute("aria-label", e);
        iga(d);
    ...
    _.sm.prototype.j = function() {
        ...
        if (0 === _.K(_.el(this.h).o, 4)) {
            var a = _.L(this.h.o, 1) + " harita kimli\u011fi yap\u0131land\u0131r\u0131lmad\u0131. Harita \u00f6zellikleri yine de kullan\u0131labilir.";
            console.warn(a);
            return !0
        }
        1 === _.K(_.el(this.h).o, 4) && (a = _.L(this.h.o, 1) + " harita kimli\u011fi yap\u0131land\u0131r\u0131lmad\u0131. Harita \u00f6zellikleri kullan\u0131lamaz.", console.warn(a));
